...
namespace ProjectBootstrap
{
    public static class PackageInstaller
    {
        ...
        // Invoke with: -executeMethod ProjectBootstrap.PackageInstaller.Install
        // Must run WITHOUT -quit: UPM resolves on later EditorApplication.update ticks,
        // so the Editor has to stay alive until Poll calls Exit itself.
